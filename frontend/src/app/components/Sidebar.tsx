...
export function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const menuItems = [
    { icon: <MessageSquare className="w-[18px] h-[18px]" />, label: 'Assistant Chat', path: '/' },
    { icon: <PackageSearch className="w-[18px] h-[18px]" />, label: 'Live Inventory', path: '/inventory' },
    { icon: <ClipboardList className="w-[18px] h-[18px]" />, label: 'Log Daily Sales', path: '/sales' },
    { icon: <BellRing className="w-[18px] h-[18px]" />, label: 'Reorder Alerts', path: '/reorder', badge: reorderCount },
    { icon: <AlertTriangle className="w-[18px] h-[18px]" />, label: 'Expirations', path: '/expired', badge: expiredCount },
  ];
