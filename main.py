...
# Debug: reaching module level
print("Main: Module level started")
...
def main():
    ...
    # Only run if authenticated to avoid unnecessary DB calls on login page
    if st.session_state.get("authenticated"):
        try:
            ...
            st.error(f"Main: Error during midnight deductions: {e}")
...
# Call the main function to handle initial setup and authentication
main()
